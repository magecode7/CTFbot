...
but_edit_visible = 'Изменить видимость'
...
text_user_missed = 'Вы не зарегистрированы в боте, пожалуйста, введите /start'
...
text_edit_tasks_line = '\n{0}) {1}'
text_edit_task_entered = 'Выбрано задание ID {0}'
text_edit_task_notentered = 'Задания не существует!'
text_task_full = '\n\n{0}\n\nОчки: {1}\n\nОписание:\n{2}\n\nФлаг: {3}\nВладелец: {4}\nВидимость: {5}'
text_task = '{0} ({1})\n\n{2}'
...
text_scoreboard = 'Рейтинг пользователей:'
...
keyboard_edit_task.add(*[but_edit_name, but_edit_desc, but_edit_flag,
                       but_edit_points, but_edit_visible, but_delete_task, but_back])
